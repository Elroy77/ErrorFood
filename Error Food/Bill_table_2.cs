...
{
    public partial class Bill_table_2 : Form
    {
        ...
        private void Bill_table_2_Load(object sender, EventArgs e)
        {
            ...
            //
            sqlcon.Open();
            string Sum = "select Sum(PriceFood_) as N'Tổng tiền' from OrderTable,TableuCount where OrderTable.IDTable_ = TableuCount.ID_ and TableuCount.ID_ = '2'";
        ...
        {
            sqlcon.Open();
            string newcommand = "delete OrderTable where IDTable_ = '2'";
