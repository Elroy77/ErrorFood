...
{
    public partial class Bill_table_5 : Form
    {
        ...
        {
            sqlcon.Open();
            string newcommand = "delete OrderTable where IDTable_ = '5'";
        ...
        private void Bill_table_5_Load(object sender, EventArgs e)
        {
            ...
            //
            sqlcon.Open();
            string Sum = "select Sum(PriceFood_) as N'Tổng tiền' from OrderTable,TableuCount where OrderTable.IDTable_ = TableuCount.ID_ and TableuCount.ID_ = '5'";
